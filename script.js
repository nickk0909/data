...
function validateForm() {
  ...
  if (firstName == "") {
    alert("requied fill First Name!!! ");
    return false;
  } else if (lastName == "") {
    alert("requied fill Last Name!!! ");
    return false;
  } else if (email == "") {
    alert("requied fill Email!!! ");
    return false;
  ...
  if( 18 > ageY){
    alert("You are not eligible because 18 years not completed");
    return false;
  }
  if( 99 < ageY){
    alert("You age 100 years more please contact administrator ");
    return false;
  }
